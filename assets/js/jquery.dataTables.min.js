...
! function(n) {
          ...
          return $.factory(t, H) ? $ : this instanceof $ ? V(t).DataTable(H) : (X = void 0 === (H = t), B = (W = this).length, X && (H = {}), this.api = function() {
              ...
              if ("table" != this.nodeName.toLowerCase()) Z(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                  ...
                  var g, m, v, b, y, D, x, S = u,
                      ...
                      C = S.aoColumns;
                  if (T)
                      for (g = 0, m = T.length; g < m; g++) T[g] && T[g].name && (C[g].sName = T[g].name);
                  if (w)
                  ...
                  if (T)
                      for (g = 0, m = T.length; g < m; g++) _(g, T[g]);
  ...
  function S(t, e) {
      if (r = "ssp" == et(s = t), void 0 !== (i = s.iInitDisplayStart) && -1 !== i && (s._iDisplayStart = !r && i >= s.fnRecordsDisplay() ? 0 : i, s.iInitDisplayStart = -1), -1 !== tt(t, "aoPreDrawCallback", "preDraw", [t]).indexOf(!1)) T(t, !1);
      else {
          var l, n = [],
              a = 0,
              r = "ssp" == et(t),
  ...
  function jt(t, e, n, a, r) {
      if ("" !== n)
          for (var o = 0, i = "function" == typeof n ? n : null, l = n instanceof RegExp ? n : i ? null : function(t, e) {
                  var a = [],
                      e = V.extend({}, {
                          boundary: !1,
                          caseInsensitive: !0,
  ...
  function Xt(e) {
      ...
      if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis) e.scrollBarVis = f, M(e);
          ...
          if (e.scrollBarVis = f, u.children("thead, tfoot").remove(), (f = s.clone().prependTo(u)).find("th, td").removeAttr("tabindex"), f.find("[id]").removeAttr("id"), c && (m = c.clone().prependTo(u)).find("[id]").removeAttr("id"), e.aiDisplay.length)
              for (var h = u.find("tbody tr").eq(0).find("th, td").map(function(t) {
                      return {
                          idx: H(e, t),
